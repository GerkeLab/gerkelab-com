...
Note that this approach can work particularly well with rmdformats or other R Markdown theming. For example, here is the above workflow embedded in `rmdformats::robobook` which can be found in [this repo](https://github.com/tgerke/crosstalk-with-dt) with [corresponding interactive webpage](https://tgerke.github.io/crosstalk-with-dt/). Enjoy!

<div style="width: 100%; display: flex; align-content: center;">
  <div style="margin: auto;">
  <img src="/blog/2021-09-16-2021-09-16-crosstalk-with-dt_files/crosstalk-with-dt.gif" style="max-width: 600px" />
  </div>
</div>